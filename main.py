...
"""
the input directroy should contain the debateorg.json, debatepedia.json, debatewise.json, idebate.json, parliamentary.json and the topics.xml file. 
"""
...
#the name of the index you want to work with
index_name = "local_index_v1.0"

# create an index with index_name
